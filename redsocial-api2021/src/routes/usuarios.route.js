...
router.put(
  ...
  validacion.verifyToken,
  usuarios.update
);
router.put(
  "/updateImagen/:id_usuario",
  uploader,
  validacion.verifyToken,
  usuarios.updateImagen
);
...
router.get(
  "/aceptarAmigo/:id_usuario/:id_amigo",
  validacion.verifyToken,
  amigos.aceptar_amistad
);
router.get(
  "/bloquearAmigo/:id_usuario/:id_amigo",
  validacion.verifyToken,
  amigos.bloquear_amistad
);
router.get(
  "/desbloquearAmigo/:id_usuario/:id_amigo",
  validacion.verifyToken,
  amigos.desbloquear_amistad
);
router.get(
  "/seguirAmigo/:id_usuario/:id_amigo",
  validacion.verifyToken,
  amigos.seguir_amigo
);
router.get(
  "/dejarseguirAmigo/:id_usuario/:id_amigo",
  validacion.verifyToken,
  amigos.dejar_seguir_amigo
);
router.delete(
  "/deleteAmigo/:id_usuario/:id_amigo",
  validacion.verifyToken,
  amigos.delete
);
router.get("/amigo/:id_usuario/:id_provincia", amigos.getamigos);
router.get("/seguidores/:id_usuario/:id_provincia", amigos.getcantSeguid);
router.get(
  "/solocitudesAmistad/:id_usuario/:id_provincia",
  validacion.verifyToken,
  amigos.getSolicitudAmigos
);
